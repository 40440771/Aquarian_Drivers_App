...
public class Login extends AppCompatActivity {
    ...
    private void POST_Request(String username, String password){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                "http://soc-web-liv-82.napier.ac.uk/api/drivers/login?Username="+username+"&Password="+password,
    ...
    public void parseData(String response) {
        try {
            ...
            if (jsonObject.getString("Status").equals("Success")) {
                new GetData(Login.this).execute("http://soc-web-liv-82.napier.ac.uk/api/jobs", "jobsFile");
